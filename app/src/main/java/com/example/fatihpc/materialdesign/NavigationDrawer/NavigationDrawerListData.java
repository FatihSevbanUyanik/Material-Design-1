...
public class NavigationDrawerListData {

    private String itemName;
    private int   itemImage;

    public NavigationDrawerListData(String itemName, int itemImage) {
    ...
    public static ArrayList<NavigationDrawerListData> getData() {

        ArrayList<NavigationDrawerListData>
                navigationDrawerListData = new ArrayList<>();
        ...
        for ( int i = 0 ; i < imageIDs.length ; i++ ) {
            String itemName = "LandscapeListData " + (i+1);
            navigationDrawerListData.add( new NavigationDrawerListData( itemName , imageIDs[i] ) );
        }

        return navigationDrawerListData;
    }
